...
VISION_CAPABLE_MODELS = {
    ...
    "o3", "o3-pro", "o4-mini",
    # Anthropic
    "claude-opus-4-6", "claude-opus-4-5-20251101", "claude-sonnet-4-6", "claude-sonnet-4-5-20250929", "claude-haiku-4-5-20251001",
...
class AnthropicAdapter(ProviderAdapter):
    ...
    def available_models(self) -> List[str]:
        return [
            "claude-opus-4-6",             # Most intelligent (current)
            "claude-opus-4-5-20251101",    # Previous stable Opus
